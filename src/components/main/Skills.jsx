...
const Skills = () => {
    ...
    const techData = [
        { 
            id: 'html', 
            name: 'HTML5', 
            text: 'O HTML5 é a versão mais moderna da linguagem de marcação para a web, essencial para criar sites responsivos e interativos.',
            icon: <FaHtml5 className="icons_skills" id="icon_html" />
        },
        { 
            id: 'css', 
            name: 'CSS3', 
            text: 'O CSS3 é a linguagem de estilos que define a aparência visual dos elementos HTML, permitindo criar layouts e animações.',
            icon: <FaCss3Alt className="icons_skills" id="icon_css" />
        },
        { 
            id: 'js', 
            name: 'JavaScript', 
            text: 'O JavaScript é a linguagem de programação que adiciona interatividade e dinamismo às páginas web.',
            icon: <IoLogoJavascript className="icons_skills" id="icon_js" />
        },
        {
            id: 'sass',
            name: 'Sass',
            text: 'Sass é um pré-processador CSS que permite o uso de variáveis e aninhamento, tornando o código mais organizado.',
            icon: <FaSass className="icons_skills" id="icon_sass" />
        },        
        { 
            id: 'react', 
            name: 'React', 
            text: 'O React é uma biblioteca JavaScript para construir interfaces de usuário baseada em componentes reutilizáveis.',
            icon: <FaReact className="icons_skills" id="icon_react" />
        },
        { 
            id: 'git', 
            name: 'Git', 
            text: 'O Git é um sistema de controle de versão que permite rastrear alterações no código de forma eficiente.',
            icon: <FaGitAlt className="icons_skills" id="icon_git" />
        },
        {
            id: 'figma',
            name: 'Figma',
            text: 'O Figma é uma ferramenta de design colaborativa para criação de interfaces e protótipos de alta fidelidade.',
            icon: <FaFigma className="icons_skills" id="icon_figma" />
        },
        {
            id: 'ui',
            name: 'UI Design',
            ...
            icon: (
                <div className="icons_skills custom-box-icon ui-bg">
                    <MdWeb />
                </div>
            )
        },
        {
            ...
            icon: (
                <div className="icons_skills custom-box-icon ux-bg">
                    <FaUserCheck />
                </div>
            )
        }        
    ...
    useEffect(() => {
        gsap.fromTo('.icons_skills', { opacity: 0, y: -25 }, {
            duration: 0.75, opacity: 1, y: 0, ease: 'power2.out', stagger: 0.15
        });
    }, []);
