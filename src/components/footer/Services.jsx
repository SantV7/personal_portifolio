        ...
        <>
          <footer id="footer">
            ...
            <div id="area_icons_contact">
                <a target='_blank' className="icones_contact_link" href="https://www.instagram.com/__sant_v/">
                  <FaInstagram  id="instagram_icon" className="icons_contact" size={48} />
                </a>
                <a target='_blank' className="icones_contact_link" href="https://www.linkedin.com/in/viniciussant07">
                  <FaLinkedin id="linkedin_icon" className="icons_contact" size={48} />
                </a>
                <a target='_blank' className="icones_contact_link" href="www.youtube.com/@vy.S17">
                  <FaYoutube id="yt_icon" className="icons_contact" size={48} />
                </a>
                <a target='_blank' className="icones_contact_link" href="https://github.com/SantV7">
                  <FaGithub id="github_icon" className="icons_contact" size={48} />
                </a>
                <a target='_blank' className="icones_contact_link" href="mailto:3izuna@gmail.com">
